 ...
 */
final class Version20190317012330 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE book ADD user_id INT NOT NULL, ADD comments_quetions VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE book DROP user_id, DROP comments_quetions');
    }
}
